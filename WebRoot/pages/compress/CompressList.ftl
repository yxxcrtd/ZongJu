					...
					<div class="row-fluid">
					   <div class="ace-thumbnails">
							...
							<button class="btn btn-small btn-primary" onclick="addObj();">
								<i class="icon-plus-sign bigger-125"></i>新建包
							</button>
						</div>
							...
							<form id="form" commandName="form" action="manager" class="form-horizontal">
								<div class="row-fluid">
									<div class="control-group span3">
										<label class="control-label" for="form-field-2">包名：</label>
										<div class="controls">
											<input id="query_name" class="span10"/>
										</div>
									</div>
									<div class="control-group span3">
										<label class="control-label" for="form-field-2">简介：</label>
										<div class="controls">
											<input id="query_remark" class="span10"/>
										</div>
									</div>
								</div>
