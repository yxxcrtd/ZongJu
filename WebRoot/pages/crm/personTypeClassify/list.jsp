		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						人员类型属性分类 <small> <i class="icon-double-angle-right"></i> 人员类型属性分类列表
						</small>
					</h1>
				</div>
				<!-- ------------------导航页面部分结束----------------------------- -->
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="Editorial.CRM.PersonTypePropClassify.editObj('');">
							<i class="icon-plus-sign bigger-125"></i> 新建人员类型属性分类
						</button>
					</div>
					<!-- ------------------功能按钮结束----------------------------- -->
					...
					<form:form id="form" commandName="form" class="form-horizontal">
						<div class="row-fluid">
							...
							<div style="text-align: center;">
								<button class="btn btn-small btn-success" type="button" onclick="Editorial.CRM.PersonTypePropClassify.query();">
					...
					<div class="table-header">
                        <i class="icon-flag"></i>&nbsp;&nbsp;人员类型属性分类列表
                    </div>
