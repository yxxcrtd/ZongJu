...
<head>
<meta charset="utf-8" />
<title>人员类型属性分类维护</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<script src="${ctx}/js/common.js"></script>
<script src="${ctx}/pages/crm/personTypeClassify/list.js"></script>
<script src="${ctx}/pages/crm/personTypeClassify/edit.js"></script>
</head>
<body>
	<div class="clearfix">
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				<div class="page-header position-relative">
					<h1>
						人员类型属性分类管理<small> <i class="icon-double-angle-right"></i> <c:if test="${form.id==null||form.id=='0'||form.id==''}">
			    	新增人员类型属性分类
				...
				<div class="row-fluid">
					...
					<div class="on-down">
						<div class="control-group">
							...
							<div class="controls">
								<form:select id="parentClass" path="classify.parentClassify.id" class="span6">
									<option value="0">----选择-----</option>
									<form:options items="${form.classList}" itemLabel="name" itemValue="id"/>
								</form:select>
							</div>
						</div>
						...
						<div class="control-group" id="codeDiv">
							...
							<div class="controls">
								<form:input path="classify.code" id="code" onblur="Editorial.CRM.PersonTypePropClassify.code();" class="span6" />
						...
						<div class="control-group" id="orderDiv">
							...
							<div class="controls">
								<form:input path="classify.order" id="order" onblur="Editorial.CRM.PersonTypePropClassify.order();" class="span6" />
