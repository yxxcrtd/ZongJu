...
<head>
<meta charset="utf-8" />
<title>公司类型属性分类维护</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<script src="${ctx}/js/common.js"></script>
<script src="${ctx}/pages/crm/corpTypePropClassify/list.js"></script>
<script src="${ctx}/pages/crm/corpTypePropClassify/edit.js"></script>
</head>						  
<body>
	<div class="clearfix">
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				<div class="page-header position-relative">
					<h1>
						公司类型属性分类管理<small> <i class="icon-double-angle-right"></i> <c:if test="${form.id==null||form.id=='0'||form.id==''}">
			    	新增公司类型属性分类
				...
				<div class="row-fluid">
					...
					<form:form id="cTypePropClassifyForm" commandName="form" class="form-horizontal">
						<div class="on-down">
					 	<div class="row-fluid ">
						...
						<div class="control-group" id="codeDiv">
							...
							<div class="controls">
								<form:input path="classify.code" id="code" onblur="Editorial.CRM.CorpTypePropClassify.code();" class="span6" />
						...
						<div class="control-group" id="orderDiv">
							...
							<div class="controls">
								<form:input path="classify.order" id="order" onblur="Editorial.CRM.CorpTypePropClassify.order();" class="span6" />
