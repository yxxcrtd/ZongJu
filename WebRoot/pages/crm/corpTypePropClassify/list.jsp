		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						公司类型属性分类 <small> <i class="icon-double-angle-right"></i> 公司类型属性分类列表
						</small>
					</h1>
				</div>
				<!-- ------------------导航页面部分结束----------------------------- -->
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="Editorial.CRM.CorpTypePropClassify.editObj('');">
							<i class="icon-plus-sign bigger-125"></i> 新建公司类型属性分类
						</button>
					</div>
					<!-- ------------------功能按钮结束----------------------------- -->
					...
					<div class="table-header"><i class="icon-flag"></i>&nbsp;&nbsp;公司类型属性分类列表</div>
