...
<script src="${ctx}/pages/crm/personTypeProp/list.js"></script>
<script src="${ctx}/pages/crm/personTypeProp/edit.js"></script>
</head>
		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<form:form id="personTypePropForm" commandName="form" class="form-horizontal">
					<div class="on-down">
						<div class="row-fluid">
							<div class="control-group span6">
								<label class="control-label" for="form-field-2">分类：</label>
								<div class="controls">
									<form:select path="crmPeTypeProp.personTypePropClassify.id" id="typePropClassify" class="span8">
										<c:forEach items="${form.crmPeTpClassifyList}" var="t">
							...
							<div class="control-group span6">
								...
								<div class="controls">
									<form:input path="crmPeTypeProp.name" id="name" class="span8" />
								</div>
							</div>
						</div>
						<div class="row-fluid">
							<div class="control-group span6">
								...
								<div class="controls">
									<form:input path="crmPeTypeProp.code" id="code" class="span8" />
								</div>
							</div>
							<div class="control-group span6" id="orderDiv">
								<label class="control-label" for="form-field-1">排序：</label>
								<div class="controls">
									<form:input path="crmPeTypeProp.order" id="order"  onblur="Editorial.CRM.PersonTypeProp.order();" class="span8"/>
						...
						<div class="row-fluid">
							<div class="control-group span6">
								...
								<div class="controls">
									<form:select path="crmPeTypeProp.must" id="must" class="span8">
							...
							<div class="control-group span6" style="float: left;">
								...
								<div class="controls">
									<form:select path="crmPeTypeProp.display" id="display" class="span8">
										<form:option value="">--选择--</form:option>
						...
						<div class="row-fluid">
							<div class="control-group span6">
								...
								<div class="controls">
									<form:input path="crmPeTypeProp.internationCode" id="internationCode" class="span8" />
								</div>
							</div>
							<div class="control-group span6" id="diveffective">
								<label class="control-label" for="form-field-1">数据来源：</label>
								<div class="controls">
									<form:input path="crmPeTypeProp.source" id="source" class="span8" />
								</div>
							</div>
						</div>
						<form:hidden path="id" />
