		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						公司类型信息管理 <small> <i class="icon-double-angle-right"></i> 公司类型信息管理列表
						</small>
					</h1>
				</div>
				<!-- ------------------导航页面部分结束----------------------------- -->
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="Editorial.CRM.CorpType.editObj('');">
							<i class="icon-plus-sign bigger-125"></i> 新建公司类型信息
						</button>
					</div>
					<!-- ------------------功能按钮结束----------------------------- -->
					...
					<!-- ------------------功能页面部分结束----------------------------- -->
					<!-- ------------------列表页面部分开始----------------------------- -->
					<div class="table-header"><i class="icon-flag"></i>&nbsp;&nbsp;公司类型信息管理列表</div>
