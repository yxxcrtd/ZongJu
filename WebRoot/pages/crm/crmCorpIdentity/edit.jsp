				...
				<div class="row-fluid">
					...
					<form:form id="crmCorpIdentityForm" commandName="form" class="form-horizontal">
						...
						<div class="control-group" id="identity_type_div">
							<label class="control-label" for="form-field-1">标识分类：</label>
							<div class="controls">
								<form:input path="identity.type" id="identity_type" placeholder="标识分类" class="span6" />
						...
						<div class="control-group" id="identity_defaultFlg_div">
							...
							<div class="controls">
								<form:input path="identity.defaultFlg" id="identity_defaultFlg" placeholder="是否主标识" class="span6" />
