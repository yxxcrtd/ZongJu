					...
					<form:form id="corpTypePropForm" commandName="form" class="form-horizontal">
						...
						<div class="row-fluid">
							...
							<div class="control-group span6">
								...
								<div class="controls">
									<form:input path="crmCtypeProp.name" id="name" class="span8" />
								</div>
							</div>
						</div>
						<div class="row-fluid">
							<div class="control-group span6">
								...
								<div class="controls">
									<form:input path="crmCtypeProp.code" id="code" class="span8" />
								</div>
							</div>
						...
						<div class="row-fluid">
							<div class="control-group span6">
								...
								<div class="controls">
									<form:select path="crmCtypeProp.must" id="must" class="span8">
										<form:option value="">--选择--</form:option>
							...
							<div class="control-group span6" style="float: left;">
								...
								<div class="controls">
									<form:select path="crmCtypeProp.display" id="display" class="span8">
										<form:option value="">--选择--</form:option>
