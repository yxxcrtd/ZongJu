...
<script src="${ctx}/pages/crm/personType/list.js"></script>
<script src="${ctx}/pages/crm/personType/edit.js"></script>
</head>
		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						人员类型管理<small> <i class="icon-double-angle-right"></i> <c:if
				...
				<div class="row-fluid">
					...
					<form:form id="crmPersonTypeForm" commandName="form" class="form-horizontal">
					<div class="on-down">
						<div class="control-group" id="nameDiv">
							<label class="control-label" for="form-field-1">名称：</label>
							<div class="controls">
								<form:input path="crmPersonType.name" id="name"  onblur="Editorial.CRM.PersonType.typeName();" class="span6"/>
						...
						<div class="control-group" id="codeDiv">
							...
							<div class="controls">
								<form:input path="crmPersonType.code" id="code"  onblur="Editorial.CRM.PersonType.code();" class="span6"/>
						...
						<div class="control-group">
							...
							<div class="controls">
								<form:input path="crmPersonType.internationCode" id="internationCode" class="span6" />
							</div>
						</div>
