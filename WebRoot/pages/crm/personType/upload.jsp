...
<script src="${ctx}/pages/crm/personType/upload.js"></script>
		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						人员自定义属性信息管理 <small> <i class="icon-double-angle-right"></i> <c:if test="${form.id==null||form.id=='0'||form.id==''}">
			    	导入Excel
					...
					<form:form id="uploadPersonTypeForm" commandName="form" class="form-horizontal">
						<div class="row-fluid">
							<div class="control-group" id="txtFileDiv">
								...
								<div class="controls">
									<input type="file" name="txtFile" class="span6" id="txtFile" onmousedown="Editorial.CRM.PersonType.validateUploadDown();" /> 
