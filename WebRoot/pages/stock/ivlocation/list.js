...
Editorial.User.addObj = function() {
	var url = $('#ctx').val()+"/pages/stock/ivlocation/form/edits";
	var commonModalCss = {
		"width": "900px",
		"height": "330px",
...
Editorial.User.modObj = function(id,ifs,ir,iw,ifn) {
	var url = $('#ctx').val()+"/pages/stock/ivlocation/form/edits?id="+id+"&ifs="+ifs+"&ir="+ir+"&iw="+iw+"&ifn="+ifn;
	var commonModalCss = {
		"width": "900px",
		"height": "330px",
		"margin": "100px 0 0 -450px"
...
Editorial.User.delObj = function(id) {
	openConfirmModalInFrame(Global_Prompt_Delete_Message, function() {
		var url = $('#ctx').val()+"/pages/stock/ivlocation/form/delete?id="+id;
		$.ajax( {
			"dataType": 'json',
			"type": "POST",
			"url": url,
