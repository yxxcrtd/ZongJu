...
<script src="${ctx}/pages/stock/ivwarehouseroom/list_init.js"></script>
						...
						class="form-horizontal">
							<div class="row-fluid">
								<div class="control-group span3">
									...
									<div class="controls">
										<form:input path="name" id="query_whRoomCode" class="span10" />
									</div>
								</div>
								<div class="control-group span3">
									...
									<div class="controls">
										<form:input path="whRoomDesc" id="query_whRoomDesc" class="span10" />
									</div>
								</div>
								<div class="control-group span3">
									<label class="control-label" for="form-field-2">
