...
<script src="${ctx}/pages/stock/ivwarehouseroom/list.js"></script>
<script src="${ctx}/pages/stock/ivwarehouseroom/edit.js"></script>
			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<form:form id="form" commandName="form" action="editSubmit" class="form-horizontal">
						<div id="whRoomCodeDiv" class="control-group">
							<label class="control-label" for="form-field-1">
								仓库房间编号：
							</label>
							<div class="controls">
                 				<form:input path="obj.whRoomCode" id="whRoomCode" placeholder="仓库房间编号" onblur="Editorial.User.validateWhRoomCode();"/>
								<span id="whRoomCodeSpan" class="help-inline"></span>
							</div>
						</div>
						<div id="whRoomDescDiv" class="control-group">
							<label class="control-label" for="form-field-1">
								仓库房间描述：
							</label>
							<div class="controls">
                 				<form:input path="obj.whRoomDesc" id="whRoomDesc" placeholder="仓库房间描述" onblur="Editorial.User.validateWhRoomDesc();"/>
								<span id="whRoomDescSpan" class="help-inline"></span>
							</div>
						</div>
						<div id="WhFloorByWhIdDiv" class="control-group">
							...
							<div class="controls">
								 <form:select path="obj.warehouseFloor.whFloorId" id="WhFloorByWhId" onblur="Editorial.User.validateWhFloorByWhId();">
