...
<script src="${ctx}/pages/stock/ivstoring/list_init.js"></script>
		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="row-fluid">
							...
							<div class="row-fluid">
								<div class="control-group span3">
									<label class="control-label" for="form-field-2">
										...
										<div class="controls">
											 <form:select path="ivLocation" id="query_ivLocation"  class="span10">
								...
								<div class="control-group span3">
									<label class="control-label" for="form-field-2">
										...
										<div class="controls">
											<form:select path="product.id" id="query_productInfo"  class="span10">
												<form:option value="">-选择-</form:option>
											<%-- 	<form:options items="${form.productInfoMap}" /> --%>
					...
					<!-- ------------------列表页面部分开始----------------------------- -->
                    <div class="table-header"><i class="icon-flag"></i>&nbsp;&nbsp;存货列表</div>
