...
<script src="${ctx}/pages/stock/ivareatype/list_init.js"></script>
		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						区域类型管理 <small> <i class="icon-double-angle-right"></i>
							区域类型管理列表
						</small>
					</h1>
				</div>
				...
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="Editorial.User.addObj();">
							<i class="icon-plus-sign bigger-125"></i> 新建区域类型
						</button>
					</div>
					<!-- ------------------功能按钮结束----------------------------- -->
							...
							<div class="row-fluid">
								<div class="control-group span3">
									<label class="control-label" for="form-field-1">
										区域类型编号： </label>
									<div class="controls">
										<form:input path="areaTypeCode" id="query_areaTypeCode"
											class="span10" />
									</div>
								</div>
								<div class="control-group span3">
									<label class="control-label" for="form-field-2">
										区域类型描述： </label>
									<div class="controls">
										<form:input path="areaTypeDesc" id="query_areaTypeDesc"
											class="span10" />
									</div>
								</div>
								</div>
