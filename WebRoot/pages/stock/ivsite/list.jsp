...
<script src="${ctx}/pages/stock/ivsite/list_init.js"></script>
				...
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="Editorial.User.addObj();">
							<i class="icon-plus-sign bigger-125"></i>新建驻地
						</button>
					</div>
					<!-- ------------------功能按钮结束----------------------------- -->
						...
						class="form-horizontal">
							<div class="row-fluid">
								<div class="control-group span3">
									...
									<div class="controls">
										<form:input path="siteCode" id="query_siteCode" class="span10" />
									</div>
								</div>
								<div class="control-group span3">
									...
									<div class="controls">
										<form:input path="siteDescription" id="query_siteDescription" class="span10" />
									</div>
								</div>
								<div class="control-group span3">
									<label class="control-label" for="form-field-2">
										...
										<div class="controls">
											 <form:select path="bRegion.id" id="query_bRegion"  class="span10">
