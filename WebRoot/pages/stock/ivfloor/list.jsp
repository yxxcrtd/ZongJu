...
<script src="${ctx}/pages/stock/ivfloor/list_init.js"></script>
		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="row-fluid">
						...
						class="form-horizontal">
							...
							<div class="row-fluid">
								<div class="control-group span3">
									...
									<div class="controls">
										<form:input path="name" id="query_shFloorCode" class="span10" />
									</div>
								</div>
								<div class="control-group span3">
									...
									<div class="controls">
										<form:input path="shFloorDesc" id="query_shFloorDesc" class="span10" />
									</div>
								</div>
								<div class="control-group span3">
									<label class="control-label" for="form-field-2">
										所属货架：
										 ...
										 <div class="controls">
											 <form:select path="ivShelf.shelfId" id="query_ivShelf"  class="span10">
					...
					<!-- ------------------列表页面部分开始----------------------------- -->
                    <div class="table-header"><i class="icon-flag"></i>&nbsp;&nbsp;层阶列表</div>
