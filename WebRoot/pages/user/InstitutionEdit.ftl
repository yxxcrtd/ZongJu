			...
			<div id="page-content" class="clearfix">
				<div class="row-fluid">
					<div class="page-header position-relative">
						<h1>机构用户信息 <small> <i class="icon-double-angle-right"></i>&nbsp;&nbsp;机构用户信息</small></h1>
					</div>
					<div class="row-fluid">
						...
						<form id="UserForm" commandName="form" class="form-horizontal">
							<div class="on-down">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input style="border:0px" class="span6" value="${form.obj.institutionName}" readonly/>
										<span class="help-inline"></span>
									</div>
								</div>
								<div class="control-group" id="nameDiv">
									...
									<div class="controls">
										<input style="border:0px" class="span6" value="${form.obj.productTypeId.name}" readonly/>
								...
								<div class="control-group" id="discountDiv">
									...
									<div class="controls">
										<input id="discount"  name="obj.discount" class="span6" value="${form.obj.discount}"  onblur="ZongJu.User.disCount();"/>%
