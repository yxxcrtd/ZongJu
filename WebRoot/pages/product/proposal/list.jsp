			...
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						策划管理
						 <small>
						 	<i class="icon-double-angle-right"></i> 策划管理列表
						</small>
					</h1>
				</div>
				<!-- ------------------导航页面部分结束----------------------------- -->
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="Editorial.Proposal.editObj('');">
							<i class="icon-plus-sign bigger-125"></i> 新建策划
						</button>
					</div>
					<!-- ------------------功能按钮结束----------------------------- -->
						...
						<div class="row-fluid">
							<div class="row-fluid">
								<div class="control-group span3">
									...
									<div class="controls">
										<form:input path="name" id="query_proposal_name" class="span10" />
									</div>
								</div>
								<div class="control-group span3">
									<label class="control-label" for="form-field-1">描述：</label>
									<div class="controls">
										<form:input path="desc" id="query_proposal_desc" class="span10" />
									</div>
								</div>
							</div>

							<div style="text-align: center;">
								<button class="btn btn-small btn-success" type="button" onclick="Editorial.Proposal.query();">
					...
					<!-- ------------------功能页面部分结束----------------------------- -->
					<!-- ------------------列表页面部分开始----------------------------- -->
					<div class="table-header"><i class="icon-flag"></i>&nbsp;&nbsp;策划列表</div>
