...
<script src="${ctx}/pages/product/composingType/tree_init.js"></script>
<script src="${ctx}/pages/product/composingType/tree.js"></script>
		...
		<div id="sidebar-shortcuts">
			...
			<div id="rMenu">
				<ul>
					...
					<li id="classify" onclick='BMEP.Product.ProductType.Tree.showClassifyList();' onmouseover="this.style.backgroundColor='#b6bdd2';" onmouseout="this.style.backgroundColor='';">类型分类管理</li>
					<li id="property" onclick='BMEP.Product.ProductType.Tree.showPropertyList();' onmouseover="this.style.backgroundColor='#b6bdd2';" onmouseout="this.style.backgroundColor='';">类型属性管理</li>
					<li id="upload" onclick='BMEP.Product.ProductType.Tree.auploadObj();' onmouseover="this.style.backgroundColor='#b6bdd2';" onmouseout="this.style.backgroundColor='';">上传</li>
				</ul>
			</div>
		</div>
	</div>
					...
					<div class="row-fluid">
						...
						<div class="row-fluid">
							...
							<div class="table-header">
                                <i class="icon-flag"></i>&nbsp;&nbsp;发排单类型属性分类列表
                            </div>
			...
			<div class="clearfix">
				<div id="page-content" class="clearfix">
					<div class="row-fluid">
						...
						<div class="page-header position-relative">
							<h1>
								发排单类型属性<small> <i class="icon-double-angle-right"></i> 类型属性列表
								</small>
							</h1>
						</div>
						<!-- ------------------导航页面部分结束----------------------------- -->
									...
									<div class="row-fluid">
										<div class="row-fluid">
											<div class="control-group span3">
												<label class="control-label" for="form-field-1">名称：</label>
												<div class="controls">
													<form:input path="name" id="query_composingTypeProp_name" class="span8" />
												</div>
											</div>
											<div class="control-group span3">
												<label class="control-label" for="form-field-1">编码：</label>
												<div class="controls">
													<form:input path="code" id="query_composingTypeProp_code" class="span8" />
												</div>
											</div>
										</div>
