...
<script src="${ctx}/pages/product/author/author_list.js"></script>
</head>
<body>
	<div class="clearfix">
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						作者管理 <small> <i class="icon-double-angle-right"></i> 选择作者
						</small>
					</h1>
				</div>
				<!-- ------------------导航页面部分结束----------------------------- -->
				...
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button id="save" class="btn btn-small btn-primary" onclick="Editorial.Person.Author.saveRoleList();">
						...
						<form:form id="form" commandName="form" action="manager" class="form-horizontal">
							<div class="row-fluid">
								...
								<div style="text-align: center;">
									<button class="btn btn-small btn-success" type="button" onclick="BMEP.Person.PPersonInfo.query();">
