...
<script src="${ctx}/pages/product/structureElement/select_list.js"></script>
<style type="text/css">
.achide {
	display: block;
	word-break:keep-all;
						...
						<div class="row-fluid">
							<div class="row-fluid">
								...
								<div class="control-group span4">
									...
									<div class="controls">
										<form:input path="element.keyword" id="query_select_element_keyword" cssClass="span10" onkeydown="if (13 == event.keyCode) { $('.btn-success').focus(); }"/>
									</div>
								</div>
