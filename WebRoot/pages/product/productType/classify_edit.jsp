...
<script src="${ctx}/pages/product/productType/classify_edit.js"></script>
</head>
<body>
	<div class="clearfix">
				...
				<div class="row-fluid">
					...
					<div class="on-down">
						...
						<div class="control-group" id="orderDiv">
							...
							<div class="controls">
								<form:input path="classify.order" id="order" onblur="BMEP.PTypePropClassify.order();" class="span6" />
