...
<script src="${ctx}/pages/product/subject/edit.js"></script>
</head>
<body>
	<div class="clearfix">
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						分类管理 <small> <i class="icon-double-angle-right"></i> 选择分类
						</small>
					</h1>
				</div>
				<!-- ------------------导航页面部分结束----------------------------- -->
				...
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button id="save" class="btn btn-small btn-primary" onclick="Editorial.Product.Subject.saveRoleList();">
						...
						<form:form id="form" commandName="form" action="manager" class="form-horizontal">
							<div class="row-fluid">
								...
								<div style="text-align: center;">
									<button class="btn btn-small btn-success" type="button" onclick="Editorial.Product.Subject.query();">
					...
					<!-- ------------------列表页面部分开始----------------------------- -->
					<div class="table-header"><i class="icon-flag"></i>&nbsp;&nbsp;分类信息列表</div>
