...
<script src="${ctx}/pages/rightLicense/subsidaryRight/list.js"></script>
</head>
<body>
	<div class="clearfix">
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						版税附属权利 <small> <i class="icon-double-angle-right"></i>
							版税附属权利信息列表
						</small>
					</h1>
				</div>
				...
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="Editorial.SubsidaryRight.addObj();">
						...
						<form:form id="form" commandName="form" action="manager"
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="control-group span3">
                                    <label class="control-label" for="form-field-1">附属权利产品：</label>
                                    <div class="controls">
                                ...
                                <div class="control-group span3">
                                    <label class="control-label" for="form-field-1">附属权利级别：</label>
                                    <div class="controls">
								...
								<div class="row-fluid">
									<div class="control-group span3">
										<label class="control-label" for="form-field-2">附属权利类型：</label>
										<div class="controls">
								...
								<div style="text-align: center;">
									<button class="btn btn-small btn-success" type="button"
										onclick="Editorial.SubsidaryRight.query();">
					...
					<!-- ------------------查询结束----------------------------- -->
					<div class="table-header"><i class="icon-flag"></i>&nbsp;&nbsp;版税附属权利列表</div>
