...
<script src="${ctx}/pages/rightLicense/crRight/select_language_list.js"></script>
</head>
<body>
			...
			<div class="row-fluid">
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="Editorial.Language.selectSubmit()" type="button">
					...
					<form:hidden path="right.rlicenseId" id="language_right_rlicenseId" />
						...
						<div class="row-fluid">
							...
							<div class="row-fluid">
								...
								<div class="control-group span6">
									...
									<div class="controls">
										<form:input path="language.code" id="language_code" cssClass="span10" placeholder="编码" />
									</div>
								</div>
								...
								<div class="control-group span6">
									...
									<div class="controls">
										<form:input path="language.name" id="language_name" cssClass="span10" placeholder="名称" />
									</div>
								</div>
							...
							<div style="text-align: center;">
								<button class="btn btn-small btn-success" type="button" onclick="Editorial.Language.query()">
