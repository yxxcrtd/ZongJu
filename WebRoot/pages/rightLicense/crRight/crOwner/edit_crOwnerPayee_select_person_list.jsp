...
<script src="${ctx}/pages/rightLicense/crRight/crOwner/edit_crOwnerPayee_select_person_list.js"></script>
</head>
<body>
			...
			<div class="row-fluid">
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="Editorial.OwnerPayeeSelectPerson.selectSubmit()" type="button">
					...
					<div class="on-down" id="on_down">
						<div class="row-fluid">
							...
							<div style="text-align: center;">
								<button class="btn btn-small btn-success" type="button" onclick="Editorial.OwnerPayeeSelectPerson.query()">
