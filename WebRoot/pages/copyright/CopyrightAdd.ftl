						...
						<form id="CopyrightForm" commandName="form" class="form-horizontal">
							<div class="on-down">
								<div class="control-group" id="belongDiv">
									...
									<div class="controls">
										<input class="span6" id="belong" name="obj.belong" placeholder="版权所有人" onblur="ZongJu.Copyright.beLong();"/>
								...
								<div class="control-group" id="codeDiv">
									...
									<div class="controls">
										<input id="code" class="span6" name="obj.property" placeholder="版权所属地" />
								...
								<div class="control-group" id="startDateStrDiv">
									...
									<div id="invoiceDate" class="controls">
										<input id="startDateStr" class="span6" name="obj.startDateStr" data-format="yyyy-MM-dd HH:mm:ss" onblur="startDateStr();" />
								...
								<div class="control-group" id="endDateStrDiv">
									...
									<div id="invoiceDate2" class="controls">
										<input id="endDateStr" class="span6" name="obj.endDateStr" data-format="yyyy-MM-dd HH:mm:ss" onblur="endDateStr();" />
										<span class="add-on"> <i data-time-icon="icon-time" data-date-icon="icon-calendar" > </i></span>
									</div>
								</div>
								<div class="control-group" id="underDiv">
									...
									<div class="controls">
										<input id="under" class="span6" name="obj.under" placeholder="版权归属" onblur="ZongJu.Copyright.unDer();"/>
