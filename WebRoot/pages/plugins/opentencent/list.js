...
Editorial.User.addObj = function() {
	var url = $('#ctx').val()+"/pages/plugins/opentencent/form/edits";
	var commonModalCss = {
		"width": "900px",
		"height":"370px",
...
Editorial.User.modObj = function(id) {
	var url = $('#ctx').val()+"/pages/plugins/opentencent/form/edits?id="+id;
	var commonModalCss = {
		"width": "900px",
		"height":"370px",
		"margin": "100px 0 0 -450px"
...
Editorial.User.delObj = function(id) {
	openConfirmModalInFrame(Global_Prompt_Delete_Message, function() {
		var url = $('#ctx').val()+"/pages/plugins/opentencent/form/delete?id="+id;
		$.ajax( {
			"dataType": 'json',
			"type": "POST",
			"url": url,
