...
<script src="${ctx}/pages/base/subject/showinit.js"></script>
<style type="text/css">
div#rMenu {
	visibility: hidden;
	position: absolute;
...
<body>
	<input type="hidden" id="subjectId" value=<%=request.getParameter("id") %> />
	<div class="clearfix">
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						分类法信息 <small> <i class="icon-double-angle-right"></i> 分类法设置
						</small>
					</h1>
				</div>
