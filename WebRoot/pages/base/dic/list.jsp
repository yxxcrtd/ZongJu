...
<script src="${ctx}/pages/base/dic/list.js"></script>
		...
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				...
				<div class="page-header position-relative">
					<h1>
						数据字典 <small> <i class="icon-double-angle-right"></i>
							数据字典数据信息列表
						</small>
					</h1>
				</div>
				...
				<div class="row-fluid">
					...
					<div class="ace-thumbnails">
						<button class="btn btn-small btn-primary" onclick="BMEP.Dic.addObj('${form.classId}');">
                    ...
                    <div class="on-down">
						<form:form id="form" commandName="form" action="manager"
							...
							<div class="row-fluid">
								<div class="row-fluid">
									<div class="control-group span3">
										...
										<div class="controls">
											<form:input path="code" id="query_dic_code" class="span10" />
										</div>
									</div>
									<div class="control-group span3">
										<label class="control-label" for="form-field-1">数据字典名称：</label>
										<div class="controls">
											<form:input path="name" id="query_dic_name" class="span10" />
										</div>
									</div>
								</div>
								<div style="text-align: center;">
									<button class="btn btn-small btn-success" type="button"
										onclick="BMEP.Dic.query();">
							...
							<form:hidden path="id" />
							<form:hidden path="classId" id="bdic_id" />
						</form:form>
					</div>
					<!-- ------------------查询结束----------------------------- -->
					<div class="table-header"><i class="icon-flag"></i>&nbsp;&nbsp;数据字典列表</div>
