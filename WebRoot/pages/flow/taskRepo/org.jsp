...
<head>
    ...
    <script src="${ctx}/pages/flow/taskRepo/org.js"></script>
            ...
            <div id="sidebarDiv">
                <div id="sidebar">
                    <div id="sidebar-collapse"
                         onclick="Editorial.Flow.taskRepo.Tree.hideTree();">
                    ...
                    <div id="sidebar-shortcuts">
                        ...
                        <div id="rMenu">
                            <ul>
                                <li id="property"
                                    onclick='Editorial.Flow.taskRepo.Tree.showList();'
                                    onmouseover="this.style.backgroundColor='#b6bdd2';"
                                    onmouseout="this.style.backgroundColor='';">岗位列表
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="ace-thumbnails">
                                        <button class="btn btn-small btn-primary"
                                                onclick="Editorial.Flow.taskRepo.Tree.saveAndClose();">
                                    ...
                                    <div class="table-header"><i class="icon-flag"></i>&nbsp;&nbsp;岗位列表</div>
