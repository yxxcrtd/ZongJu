...
<head>
    ...
    <script src="${ctx}/pages/flow/design/prop/tree.js"></script>
        ...
        <div class="row-fluid">
            ...
            <div class="row-fluid">
                ...
                <div class="ace-thumbnails">
                    <button id="save" class="btn btn-small btn-primary" onclick="Editorial.JBPM.Design.Prop.saveResourceList();">
