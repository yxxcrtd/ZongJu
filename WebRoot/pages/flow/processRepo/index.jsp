...
<head>
    ...
    <script src="${ctx}/pages/flow/processRepo/index.js"></script>
</head>
<body>
        ...
        <div class="row-fluid">
            ...
            <div class="row-fluid">
                ...
                <div class="ace-thumbnails">
                    <button class="btn btn-small btn-primary" onclick="Editorial.Flow.processRepo.deploy();">
                        <i class="icon-share-alt bigger-125"></i> 发布
                    </button>
                    <button class="btn btn-small btn-primary" onclick="Editorial.Flow.processRepo.addTask();">
                ...
                <!-- ----------------------------------------------- -->
                <div id="repoContent" class="repoContent">
                </div>
            </div>
        </div>
    </div>
