...
<head>
    ...
    <script src="${ctx}/pages/flow/activity/activity.js"></script>
</head>
...
<div class="clearfix">
    ...
    <div id="page-content" class="clearfix">
        <div class="row-fluid">
            ...
            <!-- ------------------导航页面部分结束----------------------------- -->
            <div id="saveBtn" class="form-actions" style="text-align: center; padding-left: 0px;">
                <button class="btn " type="reset" onclick="Editorial.JBPM.task.activitySubmit()">
