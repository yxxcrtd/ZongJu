			...
			<div id="page-content" class="clearfix">
				<div class="row-fluid">
					<div class="page-header position-relative">
						<h1>水印信息<small> <i class="icon-double-angle-right"></i>&nbsp;&nbsp;新建</small></h1>
					</div>
					<div class="row-fluid">
						<div class="table-header on">基本信息</div>
						<form id="WatermarkForm" commandName="form" class="form-horizontal">
							<div class="on-down">
								<div class="control-group" id="contentDiv">
									<label class="control-label">内容：</label>
									<div class="controls">
										<input class="span6" id="content" name="obj.content" placeholder="内容" onblur="ZongJu.Watermark.content();"/>
								...
								<div class="control-group" id="fontDiv">
									...
									<div class="controls">
										<input id="font" class="span6" name="obj.font" placeholder="字体大小" onblur="ZongJu.Watermark.font();"/>
