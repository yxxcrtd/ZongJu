...
XDoc.version = "9.9.8";
//XDocServer地址
XDoc.server = "http://xdoc.sinaapp.com";
//XDocBuilderServer地址
XDoc.bserver = "http://xoffice.sinaapp.com";
//账号
XDoc.key = "";
/**
 * 运行XDOC
...
XDoc.form = function(id, xdoc, param, xparam) {
	if (!xdoc) { //未指定xdoc，获取表单
		...
		if (form == null || navigator.appName == "Microsoft Internet Explorer"
						&& navigator.appVersion.match(/MSIE (9|10|11|12|13|14)\./i) != null)  {
...
XDoc.builder = function(id, param) {
	...
	if (container) {
		if (param) {
			...
			names = ["xdoc", "tdoc", "clib", "xformat", "format", "to", "libServerUrl", "locale"]; 
			...
			if (bld == null || navigator.appName == "Microsoft Internet Explorer"
							&& navigator.appVersion.match(/MSIE (9|10|11|12|13|14)\./i) != null)  {
